...
`is_test = True`, но четыре запроса статистики флага не видели: экран статистики
шлюза считал проверки наравне с оплатами клиентов. У пары шлюзов было хуже: весь
показанный «доход» состоял ИЗ ОДНИХ проверок, и шлюз выглядел работающим и
зарабатывающим.
...
боевых данных это оказалась заметная доля показанной выручки.
