...
# [OVERLAY] Потолок поднят до 3.4.0. Панель 3.x нашу сборку не ломает: гейт
# стоит только СНИЗУ (ниже MIN не стартуем), а сверху был лишь алерт
# RemnawaveVersionWarningEvent — и он приходил бы владельцу на каждом старте
# бота, пугая «возможной несовместимостью» там, где несовместимости нет.
# Совместимость с 3.x обеспечивает слой в infrastructure/di/providers/remnawave.py.
REMNAWAVE_MAX_VERSION: Final[Version] = Version("3.4.0")
