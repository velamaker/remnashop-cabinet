...
_PASS_HEADERS = frozenset(
    {
        ...
        "support-url",
        # Правила маршрутизации Happ (happ://routing/…). Заголовок отдаёт сама панель:
        # в 2.x — из поля happRouting настроек подписки, в 3.x — из customResponseHeaders,
        # куда это поле переехало. Без него приложение импортирует подписку БЕЗ роутинга
        # и молча — ошибки нигде не видно, просто РФ-сайты идут в туннель.
        "routing",
