# OVERLAY базового образа: файл целиком вендорен ради ОДНОЙ правки в
# _apply_subscription — подарок/промокод с наградой SUBSCRIPTION больше не сжигает
# оставшиеся дни получателя. При обновлении базового образа перенести правку заново
# (искать по комментарию «ПРАВКА OVERLAY»).
