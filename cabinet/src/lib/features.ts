...
export type FeatureKey =
  ...
  | "bulk_days"
  | "bulk_message"
  // Переводы страницы «Информация» на языки кабинета. Нужен код нового бота
  // (параметр ?lang= у /info и /admin/info); адаптер «Бедолаги» выключает —
  // тексты там живут в ИХ CMS со своим языком по умолчанию, и наш параметр она
  // не знает: сохранение перевода затёрло бы основной текст.
  | "info_i18n"
  | "admin";
