...
/**
 * Дата И ВРЕМЯ в поясе устройства.
 *
 * Момент обновления трафика назначает панель, и считаем мы его в UTC — а человеку
 * нужно его местное время: «7 октября, 03:10» и «6 октября, 20:10» это один и тот
 * же момент, но спорить он будет с тем, что видит. Только дня тут мало: при
 * ежедневном обновлении трафика и при покупке поздно вечером разница в часах —
 * это разница «работает до утра» и «работает две минуты».
 */
