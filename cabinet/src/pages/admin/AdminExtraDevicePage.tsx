    ...
    <div className="flex flex-col gap-5">
      ...
      <section className={SECTION}>
        ...
        <p className="mt-4 text-xs text-fg-muted">
          ...
          сам, продлить место человек может в кабинете. Когда срок места вышел, докупить его
          можно снова. При смене тарифа место сгорает, а его неиспользованная стоимость идёт
          днями (если включён перенос остатка). Отменить докупку — в карточке пользователя.
        </p>
      </section>
    </div>
  );
