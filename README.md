...
**Админка** (сгруппирована по категориям)
- 📈 **Обзор** — статистика и состояние нод Remnawave в реальном времени
- 👥 **Пользователи и подписки** — выдать, продлить, удалить вручную · 🎫 поддержка
- 💳 **Продажи** — тарифы, платёжные шлюзы, промокоды, транзакции
- 📣 **Маркетинг** — рассылки и рекламные ссылки
- 🎨 **Оформление** кабинета — название, логотип, цвета
- ℹ️ **Информация** — редактируемые FAQ/Правила/Оферта и т.п.
- 🧩 **Меню бота** · 📲 **Приложения** — состав кнопок и выбор клиентов (без перезапуска)
- ✉️ **Письмо / SMTP** — текст письма с кодом, подключение почты + тест-отправка
- 🔑 **Вход через Telegram** — настройка OIDC прямо из админки
- 🌊 **RemnaWave** · ⚙️ **Настройки** · 🛡 **Аудит** действий админов
